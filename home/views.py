...
class PostDetailView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.is_authenticated and self.post_instance.user_can_like(request.user):
            can_like = True
        return render(request, 'home/detail.html', {'post':self.post_instance, 'comment':comment, 'form':self.form_class,
...
class PostDeleteView(LoginRequiredMixin, View):
    ...
    def get(self, request, post_id):
        ...
        if post.user.id == request.user.id:
            ...
            messages.error(request, 'kooni bezan be chak.', 'danger')
...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if not post.user.id == request.user.id:
            messages.error(request, 'khak bar saret oobb', 'danger')
            return redirect('home:home')
...
class PostCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, 'bazam kassher sakhti kooni', 'success')
